...
var ContextPath_1 = require("../ContentRepository/ContextPath");
var FlowQuery = (function () {
    ...
    FlowQuery.prototype.neosUiDefaultNodes = function (baseNodeType, loadingDepth, toggledNodes, clipboardNodesContextPaths) {
        this.q = this.q.neosUiDefaultNodes(baseNodeType, loadingDepth, toggledNodes.map(function (cp) { return cp.toString(); }), clipboardNodesContextPaths.map(function (cp) { return cp.toString(); }));
        return this;
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.q.get().then(function (nodes) {
                        return nodes.map(function (node) { return (__assign(__assign({}, node), { contextPath: ContextPath_1.ContextPath.fromString(node.contextPath) })); }).filter(function (node) { return node.contextPath; });
                    })];
            });
        });
    };
