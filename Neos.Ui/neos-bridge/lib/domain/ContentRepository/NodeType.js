...
function useNodeTypes(baseNodeTypeName) {
    var _a;
    var nodeTypesRegistry = NodeTypesRegistry_1.useNodeTypesRegistry();
    return (_a = nodeTypesRegistry.getSubTypesOf(baseNodeTypeName).map(function (nodeTypeName) { return nodeTypesRegistry === null || nodeTypesRegistry === void 0 ? void 0 : nodeTypesRegistry.get(nodeTypeName); }).filter(function (n) { return n; })) !== null && _a !== void 0 ? _a : [];
}
