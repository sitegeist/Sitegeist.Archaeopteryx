        ...
        <Field name="linkTypeId" initialValue={linkType.id}>{({input}) => (
            <Tabs
                ...
                renderPanel={linkType => {
                    ...
                    if (!modelFromState || (linkType.id === 'Sitegeist.Archaeopteryx:Web' && !modelFromState?.urlWithoutProtocol) || (linkType.id === 'Sitegeist.Archaeopteryx:PhoneNumber' && !modelFromState?.phoneNumber) || (linkType.id === 'Sitegeist.Archaeopteryx:Custom' && !modelFromState?.Custom)) {
