...
describe('LinType: Web', function () {
    it('is satisfied by http:// links', function () {
        var link = {
            href: 'http://www.example.com'
        };
        expect(Web_1.Web.isSuitableFor(link))
            .toBe(true);
    });
    ...
    it('returns title for undefined links', function () {
        expect(Web_1.Web.getTitle({ value: null }))
            .toBe('Web Link');
    });
    it('returns title for insecure links', function () {
        expect(Web_1.Web.getTitle({ value: { protocol: 'http', urlWithoutProtocol: 'www.example.com' } }))
            .toBe('Web Link (not secure)');
    });
    it('returns title for secure links', function () {
        expect(Web_1.Web.getTitle({ value: { protocol: 'https', urlWithoutProtocol: 'www.example.com' } }))
    ...
    it('renders preview for insecure links', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    Preview = Web_1.Web.getPreview;
                    react_1.render(React.createElement(Preview, { value: { protocol: 'http', urlWithoutProtocol: 'www.example.com' } }));
    ...
    it('renders preview for secure links', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    Preview = Web_1.Web.getPreview;
                    react_1.render(React.createElement(Preview, { value: { protocol: 'https', urlWithoutProtocol: 'www.example.com' } }));
