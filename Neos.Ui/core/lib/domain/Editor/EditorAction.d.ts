...
export declare const ValueWasUnset: import("typesafe-actions").EmptyActionCreator<"http://sitegeist.de/Sitegeist.Archaeopteryx/ValueWasUnset">;
export declare const ValueWasReset: import("typesafe-actions").EmptyActionCreator<"http://sitegeist.de/Sitegeist.Archaeopteryx/ValueWasReset">;
